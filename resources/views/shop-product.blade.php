					...
					<div class="product">
						...
						<div class="images">
							...
							<div class="owl-carousel product-slider">
								<div class="item">
									<img src="images/shop/product-slider/image-1.jpg" alt="">
								</div><!-- item -->
								<div class="item">
									<img src="images/shop/product-slider/image-2.jpg" alt="">
								</div><!-- item -->
								<div class="item">
									<img src="images/shop/product-slider/image-3.jpg" alt="">
								</div><!-- item -->
							</div><!-- product-slider -->
